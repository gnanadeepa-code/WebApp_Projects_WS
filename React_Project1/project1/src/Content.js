...
const Content = () => {
  ...
  const [count, setCount] = useState(99); //99 is the default value. useState func returns 2 values as array
  ...
  return (
    <main className="App-main">
      ...
      <p>
        <button onClick={() => handleClick2("React")}>
          {" "}
          Which Technology?
        </button>
      </p>
      ...
      <p>
        <button onDoubleClick={(event) => handleClick3(event)}>
          {" "}
          Passing event in a function
        </button>
      </p>
